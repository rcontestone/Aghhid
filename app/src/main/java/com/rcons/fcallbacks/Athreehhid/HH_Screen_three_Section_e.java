...
public class HH_Screen_three_Section_e extends Activity {
    ...
    String aghhid_e_3_8 = "";
    String aghhid_e_3_9 = "";
    String aghhid_e_3_10 = "";
    String aghhid_e_3_11 = "";
    String aghhid_e_3_12 = "";
    String aghhid_e_3_13 = "";
    String aghhid_e_3_14 = "";
    String aghhid_e_3_14_other = "";
    String aghhid_e_3_15 = "";
    String aghhid_e_3_16 = "";
    String aghhid_e_3_17 = "";
    String aghhid_e_3_18 = "";
...
RadioButton hh_edtfield_q_2_rdg_op_18 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            HH_Screen_three_Section_e.START_TIME = MpcUtil.getcurrentTime(14);



            setContentView(R.layout.section_e_screen_three);
    ...
    }public HH_Screen_three_Section_e() {
    ...
    private void initializeReferenceOfViews() {
        ...
        try {
            ...
            ArrayList<String> spinnerArray = HouseHoldDataBaseHelper.getDataBaseProcessor(HH_Screen_three_Section_e.this).aghhid_getNumbersDataagainstvillageAndhhid(appContext,school_code,student_id);
...
//            spinnerArray.add("3006854549");
            ...
            hh_edtfield_q_2_rdg_op_4= (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_4);
            hh_edtfield_q_2_rdg_op_5 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_5);
            hh_edtfield_q_2_rdg_op_6 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_6);
            hh_edtfield_q_2_rdg_op_7 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_7);
            hh_edtfield_q_2_rdg_op_8 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_8);
            hh_edtfield_q_2_rdg_op_9 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_9);
            hh_edtfield_q_2_rdg_op_10 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_10);
            hh_edtfield_q_2_rdg_op_11 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_11);
            hh_edtfield_q_2_rdg_op_12  = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_12);
            hh_edtfield_q_2_rdg_op_13 =  (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_13);
            hh_edtfield_q_2_rdg_op_14 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_14);
            hh_edtfield_q_2_rdg_op_15 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_15);
            hh_edtfield_q_2_rdg_op_16 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_16);
            hh_edtfield_q_2_rdg_op_17 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_17);
            hh_edtfield_q_2_rdg_op_18 = (RadioButton)findViewById(R.id.hh_edtfield_q_2_rdg_op_18);
...
//                    hh_edtfield_q_2.setText(aghhid_e_3);
...
//							editTextUserNameToLogin.setText(registeredEmailAddress);
    ...
    public void grabEnteredTextForSignUp(View v) {
        ...
        try {
            ...
            //AnalyticsUtil.updateEventAction(appContext, "Email Address : "+aghhid_e_3);
...
//				error = true;true
            ...
            }else if (aghhid_e_3.trim().length() == 0 ){
                ...
                MpcUtil.restartInput(appContext, hh_edtfield_q_2);
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_3.trim())){
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
//				error = true;
                ...
                error = true;
            }else if (!reTypedEmailID.trim().equalsIgnoreCase(aghhid_e_3.trim())){
                MpcUtil.hideSoftKeyBoard(appContext, editTextReTypeEmailID);
                showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_retyped_email_id_error_message_body));
                editTextReTypeEmailID.requestFocus();
                MpcUtil.restartInput(appContext, editTextReTypeEmailID);
    ...
    public void grabEnteredTextForSignUpPartTwo() {
        ...
        try {
            ...
            if (aghhid_e_3.trim().length() == 0 ){
                ...
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_3.trim())){
//				//AnalyticsUtil.updateEventAction(appContext, "Invalid Email Address : "+aghhid_e_3.trim());
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
...
//				MpcUtil.restartInput(appContext, editTextReTypeEmailID);
//				error = true;
//				//AnalyticsUtil.updateEventAction(appContext, " Re-type Email and email mismatch :"+reTypedEmailID.trim()+" email :"+aghhid_e_3.trim());
//			}else
//
...
//				DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_3"+ aghhid_e_3+"\r\npassword"+ password);
//				json = JsonHandler.createSIGNUPJsonObject(appContext, firstName, aghhid_e_3, phone,password, "careteen", "android", MpcUtil.DEVICE_UNIQUE_ID,MpcUtil.BUILD_INFO);
//				//EmailDebugLog.getInstance(appContext).writeLog(json.toString());
//				MainUserInfo.devicesTempLockPassword = password;
//				MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_3;
//			}else{
...
//			DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_3"+ aghhid_e_3+"\r\npassword"+ password);
//			MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_3;
//			String url = MpcUtil.getBaseURL(appContext)+ MpcUtil.EMAIL_ID_VERIFICATION_URL + Uri.encode(aghhid_e_3);
//
...
//			}
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                ...
                if(success) {
                    ...
                    DebugLog.console("[HH_Screen_two] inside run() Question_1 " + aghhid_e_3);
    ...
    private boolean saveDatainDataBase(  String user_name , String start_date_time) {
        ...
        try {
            ...
            DebugLog.console("[HH_Screen_two] inside saveDatainDataBase() aghhid_e_3"+aghhid_e_3+"  aghhid_c1_given_number"+aghhid_c1_given_number);
            dataSaved = HouseHoldDataBaseHelper.getDataBaseProcessor(appContext).hhid_insert_data_e3( school_code , student_id ,aghhid_e_3,  aghhid_e_3_2,  aghhid_e_3_3,  aghhid_e_3_4,  aghhid_e_3_5,  aghhid_e_3_6,  aghhid_e_3_7,  aghhid_e_3_8,  aghhid_e_3_9,  aghhid_e_3_10,  aghhid_e_3_11,  aghhid_e_3_12,  aghhid_e_3_13,  aghhid_e_3_14,  aghhid_e_3_14_other,  aghhid_e_3_15,  aghhid_e_3_16,  aghhid_e_3_17,  aghhid_e_3_18,   rcons_user , start_date_time);
            return dataSaved;
        } catch (Exception e) {
...
//		}
    ...
    private void saveDataNow() {
        ...
        try {
            ...
            boolean dataSaved = saveDatainDataBase(RConsUtils.getUserName(), HH_Screen_three_Section_e.START_TIME);
...
//				setContentView(R.layout.sign_up_part_two);
    ...
    private Handler forgot_password_Handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                DebugLog.console("code is :" + msg.what);
                success = ResponceVerifier.verifyReceievedResponce(HH_Screen_three_Section_e.this,msg.what);
                if(success){
                    if (pd!=null){
                        pd.dismiss();
                    }
    ...
    public void showAlert(String title, String message){
        new AlertDialog.Builder(HH_Screen_three_Section_e.this)
                .setTitle(title)
                .setMessage(message)
        ...
        new AlertDialog.Builder(HH_Screen_three_Section_e.this)
                ...
                .setPositiveButton(getResources().getString(R.string.registration_screen_alert_box_btn), new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int which){
                        ...
                        pd = ProgressDialog.show(HH_Screen_three_Section_e.this, getResources().getString(R.string.signin_activity_forgot_password_progress_bar_title), getResources().getString(R.string.signup_activity_forgot_password_text), true, false);
                        new Thread() {
                            public void run() {
                                try{
                                    Thread.sleep(200);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (data.length()>0){
                ...
                if(data.getString("e_3").equalsIgnoreCase("null"))
                    data.put("e_3","");



                if(data.getString("e_3_2").equalsIgnoreCase("null"))
                    data.put("e_3_2","");

                if(data.getString("e_3_3").equalsIgnoreCase("null"))
                    data.put("e_3_3","");

                if(data.getString("e_3_4").equalsIgnoreCase("null"))
                    data.put("e_3_4","");

                if(data.getString("e_3_5").equalsIgnoreCase("null"))
                    data.put("e_3_5","");

                if(data.getString("e_3_6").equalsIgnoreCase("null"))
                    data.put("e_3_6","");

                if(data.getString("e_3_7").equalsIgnoreCase("null"))
                    data.put("e_3_7","");

                if(data.getString("e_3_8").equalsIgnoreCase("null"))
                    data.put("e_3_8","");

                if(data.getString("e_3_9").equalsIgnoreCase("null"))
                    data.put("e_3_9","");

                if(data.getString("e_3_10").equalsIgnoreCase("null"))
                    data.put("e_3_10","");

                if(data.getString("e_3_11").equalsIgnoreCase("null"))
                    data.put("e_3_11","");

                if(data.getString("e_3_12").equalsIgnoreCase("null"))
                    data.put("e_3_12","");

                if(data.getString("e_3_13").equalsIgnoreCase("null"))
                    data.put("e_3_13","");

                if(data.getString("e_3_14").equalsIgnoreCase("null"))
                    data.put("e_3_14","");

                if(data.getString("e_3_14_other").equalsIgnoreCase("null"))
                    data.put("e_3_14_other","");

                if(data.getString("e_3_15").equalsIgnoreCase("null"))
                    data.put("e_3_15","");

                if(data.getString("e_3_16").equalsIgnoreCase("null"))
                    data.put("e_3_16","");


                if(data.getString("e_3_17").equalsIgnoreCase("null"))
                    data.put("e_3_17","");

                if(data.getString("e_3_18").equalsIgnoreCase("null"))
                    data.put("e_3_18","");


                aghhid_e_3 = data.getString("e_3");
                aghhid_e_3_2 = data.getString("e_3_2");
                aghhid_e_3_3 = data.getString("e_3_3");
                aghhid_e_3_4 = data.getString("e_3_4");
                aghhid_e_3_5 = data.getString("e_3_5");
                aghhid_e_3_6 = data.getString("e_3_6");
                aghhid_e_3_7 = data.getString("e_3_7");
                aghhid_e_3_8 = data.getString("e_3_8");
                aghhid_e_3_9 = data.getString("e_3_9");
                aghhid_e_3_10 = data.getString("e_3_10");
                aghhid_e_3_11 = data.getString("e_3_11");
                aghhid_e_3_12 = data.getString("e_3_12");
                aghhid_e_3_13 = data.getString("e_3_13");
                aghhid_e_3_14 = data.getString("e_3_14");
                aghhid_e_3_14_other = data.getString("e_3_14_other");
                aghhid_e_3_15 = data.getString("e_3_15");
                aghhid_e_3_16 = data.getString("e_3_16");
                aghhid_e_3_17 = data.getString("e_3_17");
                aghhid_e_3_18 = data.getString("e_3_18");
...
//		}
    ...
    public void gotohomeScreen(View view) {
        ...
        try {
            Intent intent = new Intent(HH_Screen_three_Section_e.this, MainMenuActivity.class);
//            startActivity(intent);
            Intent returnIntent = new Intent();
            returnIntent.putExtra("isDataUpdated", false);
            setResult(Activity.RESULT_OK, returnIntent);
    ...
    public void setMigration(View view) {
        ...
        }else if (view.getTag().equals("-777")){
...
//        String phoneNumber =     txt_mobile_number.getText().toString().trim();
    ...
    public void launchReport(View v) {
        ...
        try {
            ...
            EmailDebugLog.getInstance(appContext).writeLog("[HH_Screen_three_Section_e] inside launchReport() Exception is :" + e.toString());
        }
