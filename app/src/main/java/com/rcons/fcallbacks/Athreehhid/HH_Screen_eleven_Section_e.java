...
public class HH_Screen_eleven_Section_e extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            HH_Screen_eleven_Section_e.START_TIME = MpcUtil.getcurrentTime(14);



            setContentView(R.layout.section_e_screen_eleven);
    ...
    public HH_Screen_eleven_Section_e() {
        ...
        try {
            ...
            hh_edtfield_q_2.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                    ...
                    // aghhid_e_11 = hh_edtfield_q_2.getText().toString().trim();
            ...
            ArrayList<String> spinnerArray = HouseHoldDataBaseHelper.getDataBaseProcessor(HH_Screen_eleven_Section_e.this).aghhid_getNumbersDataagainstvillageAndhhid(appContext,school_code,student_id);
...
//                    hh_edtfield_q_2.setText(aghhid_e_11);
...
//							editTextUserNameToLogin.setText(registeredEmailAddress);
    ...
    public void grabEnteredTextForSignUp(View v) {
        ...
        try {
            ...
            //AnalyticsUtil.updateEventAction(appContext, "Email Address : "+aghhid_e_11);
...
//				error = true;true
            ...
            }else if (aghhid_e_11.trim().length() == 0 ){
                ...
                MpcUtil.restartInput(appContext, hh_edtfield_q_2);
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_11.trim())){
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
//				error = true;
                ...
                error = true;
            }else if (!reTypedEmailID.trim().equalsIgnoreCase(aghhid_e_11.trim())){
                MpcUtil.hideSoftKeyBoard(appContext, editTextReTypeEmailID);
                showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_retyped_email_id_error_message_body));
                editTextReTypeEmailID.requestFocus();
                MpcUtil.restartInput(appContext, editTextReTypeEmailID);
    ...
    public void HandleNextButnClick(View v) {
        ...
        try {
            ...
            if (aghhid_e_11.length()==0){
                error =  true;
                showAlert(appContext.getResources().getString(R.string.app_name),"Please Select Some value");
                // MpcUtil.restartInput(appContext, hh_edtfield_q_2);
            }else 	if (aghhid_e_11.equalsIgnoreCase("1")  && e11_day.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e11_day);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Day");


                error = true;

            }else 	if (aghhid_e_11.equalsIgnoreCase("1")  && e11_month.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e11_month);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Month");


                error = true;

            }else 	if (aghhid_e_11.equalsIgnoreCase("1")  && e11_hh.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e11_hh);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Hour");


                error = true;

            }else if (aghhid_e_11.equalsIgnoreCase("1")  && e11_mm.equalsIgnoreCase(MinutesList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e11_mm);
    ...
    public void grabEnteredTextForSignUpPartTwo() {
        ...
        try {
            ...
            if (aghhid_e_11.trim().length() == 0 ){
                ...
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_11.trim())){
//				//AnalyticsUtil.updateEventAction(appContext, "Invalid Email Address : "+aghhid_e_11.trim());
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
...
//				MpcUtil.restartInput(appContext, editTextReTypeEmailID);
//				error = true;
//				//AnalyticsUtil.updateEventAction(appContext, " Re-type Email and email mismatch :"+reTypedEmailID.trim()+" email :"+aghhid_e_11.trim());
//			}else
//
...
//				DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_11"+ aghhid_e_11+"\r\npassword"+ password);
//				json = JsonHandler.createSIGNUPJsonObject(appContext, firstName, aghhid_e_11, phone,password, "careteen", "android", MpcUtil.DEVICE_UNIQUE_ID,MpcUtil.BUILD_INFO);
//				//EmailDebugLog.getInstance(appContext).writeLog(json.toString());
//				MainUserInfo.devicesTempLockPassword = password;
//				MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_11;
//			}else{
...
//			DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_11"+ aghhid_e_11+"\r\npassword"+ password);
//			MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_11;
//			String url = MpcUtil.getBaseURL(appContext)+ MpcUtil.EMAIL_ID_VERIFICATION_URL + Uri.encode(aghhid_e_11);
//
...
//			}
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                ...
                if(success) {
                    ...
                    DebugLog.console("[HH_Screen_two] inside run() Question_1 " + aghhid_e_11);
    ...
    private boolean saveDatainDataBase(  String user_name , String start_date_time) {
        ...
        try {
            ...
            DebugLog.console("[HH_Screen_two] inside saveDatainDataBase() aghhid_e_11"+aghhid_e_11+"  aghhid_c1_given_number"+aghhid_c1_given_number);
            dataSaved = HouseHoldDataBaseHelper.getDataBaseProcessor(appContext).hhid_insert_data_e11( school_code , student_id ,aghhid_e_11,e11_day,e11_month,e11_hh,e11_mm,   rcons_user , start_date_time);
            return dataSaved;
        } catch (Exception e) {
...
//		}
    ...
    private void saveDataNow() {
        ...
        try {
            ...
            boolean dataSaved = saveDatainDataBase(RConsUtils.getUserName(), HH_Screen_eleven_Section_e.START_TIME);
            ...
            if (dataSaved){
                ...
                if (screen_two ) {
                    ...
                    if(aghhid_e_11.equalsIgnoreCase("1") ||aghhid_e_11.equalsIgnoreCase("-777") || (aghhid_e_11.equalsIgnoreCase("-99"))){
                        Intent intent = new Intent(HH_Screen_eleven_Section_e.this, AddReportActivity.class);
...
//				setContentView(R.layout.sign_up_part_two);
    ...
    private Handler forgot_password_Handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                DebugLog.console("code is :" + msg.what);
                success = ResponceVerifier.verifyReceievedResponce(HH_Screen_eleven_Section_e.this,msg.what);
                if(success){
                    if (pd!=null){
                        pd.dismiss();
                    }
    ...
    public void showAlert(String title, String message){
        new AlertDialog.Builder(HH_Screen_eleven_Section_e.this)
                .setTitle(title)
                .setMessage(message)
        ...
        new AlertDialog.Builder(HH_Screen_eleven_Section_e.this)
                ...
                .setPositiveButton(getResources().getString(R.string.registration_screen_alert_box_btn), new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int which){
                        ...
                        pd = ProgressDialog.show(HH_Screen_eleven_Section_e.this, getResources().getString(R.string.signin_activity_forgot_password_progress_bar_title), getResources().getString(R.string.signup_activity_forgot_password_text), true, false);
                        new Thread() {
                            public void run() {
                                try{
                                    Thread.sleep(200);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (data.length()>0){
                ...
                if(data.getString("e_11").equalsIgnoreCase("null"))
                    data.put("e_11","");

                hh_edtfield_q_2.setText(data.getString("e_11"));
                ...
                String e_11= data.getString("e_11");
                aghhid_e_11 =e_11;
                ...
                if(e_11.trim().equalsIgnoreCase("1")) {
                    ...
                    if(data.getString("e11_day").equalsIgnoreCase("null"))
                        data.put("e11_day","");

                    if(data.getString("e11_month").equalsIgnoreCase("null"))
                        data.put("e11_month","");

                    if(data.getString("e11_hh").equalsIgnoreCase("null"))
                        data.put("e11_hh","");

                    if(data.getString("e11_mm").equalsIgnoreCase("null"))
                        data.put("e11_mm","");
                    ...
                    e11_day =data.getString("e11_day");
                    e11_month =data.getString("e11_month");
                    e11_hh =data.getString("e11_hh");
                    e11_mm =data.getString("e11_mm");
                    ...
                    int index = daysList.indexOf(e11_day);
                    ...
                    index = daysList.indexOf(e11_month);
                    ...
                    index = hoursList.indexOf(e11_hh);
                    spiiner_hour.setSelection(index);

                    String[] myStringArrayMinutes = appContext.getResources().getStringArray(R.array.array_mins);
                    List<String> MinutesList = Arrays.asList( myStringArrayMinutes );

                    index = MinutesList.indexOf(e11_mm);
...
//		}
    ...
    public void gotohomeScreen(View view) {
        ...
        try {
            Intent intent = new Intent(HH_Screen_eleven_Section_e.this, MainMenuActivity.class);
//            startActivity(intent);
            Intent returnIntent = new Intent();
            returnIntent.putExtra("isDataUpdated", false);
            setResult(Activity.RESULT_OK, returnIntent);
...
//        String phoneNumber =     txt_mobile_number.getText().toString().trim();
    ...
    public void launchReport(View v) {
        ...
        try {
            ...
            EmailDebugLog.getInstance(appContext).writeLog("[HH_Screen_eleven_Section_e] inside launchReport() Exception is :" + e.toString());
        }
