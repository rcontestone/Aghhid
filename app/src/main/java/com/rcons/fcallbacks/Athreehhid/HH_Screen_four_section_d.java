...
public class HH_Screen_four_section_d extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            HH_Screen_four_section_d.START_TIME = MpcUtil.getcurrentTime(14);



            setContentView(R.layout.section_d_screen_four);
    ...
    }public HH_Screen_four_section_d() {
    ...
    private void initializeReferenceOfViews() {
        ...
        try {
            ...
            DebugLog.console("[HH_Screen_two] inside HH_Screen_four_section_d() currentPSUCode "+currentPSUCode);
            ...
            DebugLog.console("[HH_Screen_two] inside HH_Screen_four_section_d() last_strict_id_against_psu "+last_strict_id_against_psu);
...
//            spinnerArray.clear();
            ...
            ArrayList<String> spinnerArray3 = HouseHoldDataBaseHelper.getDataBaseProcessor(HH_Screen_four_section_d.this).aghhid_getgirlsgainstvillageAndhhid_second_op(appContext,school_code,student_id);
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int i, long id) {
                    ...
                    try {
                        if (i==0){
                            ...
                            int memID  = HouseHoldDataBaseHelper.getDataBaseProcessor(HH_Screen_four_section_d.this).aghhid_memberid_against_name(appContext,school_code,student_id, parent.getSelectedItem().toString().trim());
...
//				error = true;
    ...
    public void HandleNextButnClick(View v) {
        ...
        try {
            ...
            d_9_resp_name = numbers_sp_q_2.getSelectedItem().toString();
            //   d_9_resp_name = hh_edtfield_q_2.getText().toString();
            int rdg_checkedID = 1;
...
//			}
    ...
    private boolean saveDatainDataBase(  String user_name , String start_date_time) {
        ...
        try {
            ...
            dataSaved = HouseHoldDataBaseHelper.getDataBaseProcessor(appContext).hhid_insert_data_d9( school_code , student_id ,d_9_resp_name, d_9_resp_id,  rcons_user , start_date_time);
            return dataSaved;
        } catch (Exception e) {
...
//		}
    ...
    private void saveDataNow() {
        ...
        try {
            ...
            boolean dataSaved = saveDatainDataBase(RConsUtils.getUserName(), HH_Screen_four_section_d.START_TIME);
...
//				setContentView(R.layout.sign_up_part_two);
    ...
    private Handler forgot_password_Handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                DebugLog.console("code is :" + msg.what);
                success = ResponceVerifier.verifyReceievedResponce(HH_Screen_four_section_d.this,msg.what);
                if(success){
                    if (pd!=null){
                        pd.dismiss();
                    }
    ...
    public void showAlert(String title, String message){
        new AlertDialog.Builder(HH_Screen_four_section_d.this)
                .setTitle(title)
                .setMessage(message)
...
//            startActivity(intent);
        ...
        new AlertDialog.Builder(HH_Screen_four_section_d.this)
                ...
                .setPositiveButton(getResources().getString(R.string.registration_screen_alert_box_btn), new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int which){
                        ...
                        pd = ProgressDialog.show(HH_Screen_four_section_d.this, getResources().getString(R.string.signin_activity_forgot_password_progress_bar_title), getResources().getString(R.string.signup_activity_forgot_password_text), true, false);
                        new Thread() {
                            public void run() {
                                try{
                                    Thread.sleep(200);
    ...
    protected void onStart() {
        ...
        try {
            ...
            JSONObject data = HouseHoldDataBaseHelper.getDataBaseProcessor(appContext).aghhid_getDataFromtable(appContext, DatabaseAdapter.aghhid_section_d_table,school_code,student_id);
            DebugLog.console("[HH_Screen_two] inside onStart() "+data.toString());

            if (data.length()>0) {

                if (data.getString("d_9_resp_name").equalsIgnoreCase("null"))
                    data.put("d_9_resp_name", "");

                //  hh_edtfield_q_2.setText(data.getString("d_9_resp_name"));
                d_9_resp_name = data.getString("d_9_resp_name");


                if (data.getString("d_9_resp_id").equalsIgnoreCase("null"))
                    data.put("d_9_resp_id", "");


                String e_1_other = data.getString("d_9_resp_id");
                d_9_resp_id = e_1_other;
            ...
            if  (d_9_resp_id.length()!=0){
                hh_edtfield_q_2.setText("Mem ID : "+d_9_resp_id);
                DebugLog.console("[HH_Screen_four_section_d] inside onStart() d_9_resp_id "+d_9_resp_id);

            }


            if(d_9_resp_name.length()!=0){
                DebugLog.console("[HH_Screen_four_section_d] inside onStart() d_9_resp_name "+d_9_resp_name);
                int pos = spinnerArrayAdapter.getPosition(d_9_resp_name);
                numbers_sp_q_2.setSelection(pos);
            }
...
//		}
    ...
    public void gotohomeScreen(View view) {
        ...
        try {
            Intent intent = new Intent(HH_Screen_four_section_d.this, MainMenuActivity.class);
//            startActivity(intent);
            Intent returnIntent = new Intent();
            returnIntent.putExtra("isDataUpdated", false);
            setResult(Activity.RESULT_OK, returnIntent);
