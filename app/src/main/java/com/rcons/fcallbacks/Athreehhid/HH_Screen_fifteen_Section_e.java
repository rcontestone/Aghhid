...
public class HH_Screen_fifteen_Section_e extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            HH_Screen_fifteen_Section_e.START_TIME = MpcUtil.getcurrentTime(14);



            setContentView(R.layout.section_e_screen_fifteen);
    ...
    public HH_Screen_fifteen_Section_e() {
        ...
        try {
            ...
            hh_edtfield_q_2.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                    ...
                    // aghhid_e_15 = hh_edtfield_q_2.getText().toString().trim();
            ...
            ArrayList<String> spinnerArray = HouseHoldDataBaseHelper.getDataBaseProcessor(HH_Screen_fifteen_Section_e.this).aghhid_getNumbersDataagainstvillageAndhhid(appContext,school_code,student_id);
...
//                    hh_edtfield_q_2.setText(aghhid_e_15);
...
//							editTextUserNameToLogin.setText(registeredEmailAddress);
    ...
    public void grabEnteredTextForSignUp(View v) {
        ...
        try {
            ...
            //AnalyticsUtil.updateEventAction(appContext, "Email Address : "+aghhid_e_15);
...
//				error = true;true
            ...
            }else if (aghhid_e_15.trim().length() == 0 ){
                ...
                MpcUtil.restartInput(appContext, hh_edtfield_q_2);
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_15.trim())){
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
//				error = true;
                ...
                error = true;
            }else if (!reTypedEmailID.trim().equalsIgnoreCase(aghhid_e_15.trim())){
                MpcUtil.hideSoftKeyBoard(appContext, editTextReTypeEmailID);
                showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_retyped_email_id_error_message_body));
                editTextReTypeEmailID.requestFocus();
                MpcUtil.restartInput(appContext, editTextReTypeEmailID);
    ...
    public void HandleNextButnClick(View v) {
        ...
        try {
            ...
            e15_day =   spiiner_day.getSelectedItem().toString();
            e15_month =       spiiner_month.getSelectedItem().toString();
            e15_hh = spiiner_hour.getSelectedItem().toString();
            e15_mm = spiiner_min.getSelectedItem().toString();


            String[] myStringArrayHours = appContext.getResources().getStringArray(R.array.array_hours);
            List<String> hoursList = Arrays.asList( myStringArrayHours );

            String[] myStringArrayMinutes = appContext.getResources().getStringArray(R.array.array_mins);
            List<String> MinutesList = Arrays.asList( myStringArrayMinutes );
            ...
            if (aghhid_e_15.length()==0){
                error =  true;
                showAlert(appContext.getResources().getString(R.string.app_name),"Please Select Some value");
                // MpcUtil.restartInput(appContext, hh_edtfield_q_2);
            }else 	if (aghhid_e_15.equalsIgnoreCase("1")  && e15_day.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e15_day);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Day");


                error = true;

            }else 	if (aghhid_e_15.equalsIgnoreCase("1")  && e15_month.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e15_month);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Month");


                error = true;

            }else 	if (aghhid_e_15.equalsIgnoreCase("1")  && e15_hh.equalsIgnoreCase(hoursList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e15_hh);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Hour");


                error = true;

            }else if (aghhid_e_15.equalsIgnoreCase("1")  && e15_mm.equalsIgnoreCase(MinutesList.get(0).toString())){
                DebugLog.console("[HH_Screen_eleven_Section_e] inside checkAndMoveToRespective_Screen() hour "+e15_mm);
                showAlert(appContext.getResources().getString(R.string.app_name), "Please Select Minutes");
    ...
    public void grabEnteredTextForSignUpPartTwo() {
        ...
        try {
            ...
            if (aghhid_e_15.trim().length() == 0 ){
                ...
                error = true;
//			}else if (!MpcUtil.isEmailValid(aghhid_e_15.trim())){
//				//AnalyticsUtil.updateEventAction(appContext, "Invalid Email Address : "+aghhid_e_15.trim());
//				MpcUtil.hideSoftKeyBoard(appContext, hh_edtfield_q_2);
//				showAlert(getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_title),getResources().getString(R.string.signup_activity_emailaddress_field_empty_message_body));
//				hh_edtfield_q_2.requestFocus();
//				MpcUtil.restartInput(appContext, hh_edtfield_q_2);
...
//				MpcUtil.restartInput(appContext, editTextReTypeEmailID);
//				error = true;
//				//AnalyticsUtil.updateEventAction(appContext, " Re-type Email and email mismatch :"+reTypedEmailID.trim()+" email :"+aghhid_e_15.trim());
//			}else
//
...
//				DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_15"+ aghhid_e_15+"\r\npassword"+ password);
//				json = JsonHandler.createSIGNUPJsonObject(appContext, firstName, aghhid_e_15, phone,password, "careteen", "android", MpcUtil.DEVICE_UNIQUE_ID,MpcUtil.BUILD_INFO);
//				//EmailDebugLog.getInstance(appContext).writeLog(json.toString());
//				MainUserInfo.devicesTempLockPassword = password;
//				MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_15;
//			}else{
...
//			DebugLog.console("userName: "+userName+"\r\nfirstName"+ firstName+ "\r\nlastName"+lastName+"\r\naghhid_e_15"+ aghhid_e_15+"\r\npassword"+ password);
//			MainUserInfo.REGISTERED_EMAIL_ADDRESS = aghhid_e_15;
//			String url = MpcUtil.getBaseURL(appContext)+ MpcUtil.EMAIL_ID_VERIFICATION_URL + Uri.encode(aghhid_e_15);
//
...
//			}
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                ...
                if(success) {
                    ...
                    DebugLog.console("[HH_Screen_two] inside run() Question_1 " + aghhid_e_15);
    ...
    private boolean saveDatainDataBase(  String user_name , String start_date_time) {
        ...
        try {
            ...
            DebugLog.console("[HH_Screen_two] inside saveDatainDataBase() aghhid_e_15"+aghhid_e_15+"  aghhid_c1_given_number"+aghhid_c1_given_number);
            dataSaved = HouseHoldDataBaseHelper.getDataBaseProcessor(appContext).hhid_insert_data_e15( school_code , student_id ,aghhid_e_15,e15_day,e15_month,e15_hh,e15_mm,   rcons_user , start_date_time);
            return dataSaved;
        } catch (Exception e) {
...
//		}
    ...
    private void saveDataNow() {
        ...
        try {
            ...
            boolean dataSaved = saveDatainDataBase(RConsUtils.getUserName(), HH_Screen_fifteen_Section_e.START_TIME);
...
//                    if(aghhid_e_15.equalsIgnoreCase("1") ||aghhid_e_15.equalsIgnoreCase("-777") || (aghhid_e_15.equalsIgnoreCase("-99"))){
                    Intent intent = new Intent(HH_Screen_fifteen_Section_e.this, AddReportActivity.class);
...
//				setContentView(R.layout.sign_up_part_two);
    ...
    private Handler forgot_password_Handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try{
                DebugLog.console("code is :" + msg.what);
                success = ResponceVerifier.verifyReceievedResponce(HH_Screen_fifteen_Section_e.this,msg.what);
                if(success){
                    if (pd!=null){
                        pd.dismiss();
                    }
    ...
    public void showAlert(String title, String message){
        new AlertDialog.Builder(HH_Screen_fifteen_Section_e.this)
                .setTitle(title)
                .setMessage(message)
        ...
        new AlertDialog.Builder(HH_Screen_fifteen_Section_e.this)
                ...
                .setPositiveButton(getResources().getString(R.string.registration_screen_alert_box_btn), new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int which){
                        ...
                        pd = ProgressDialog.show(HH_Screen_fifteen_Section_e.this, getResources().getString(R.string.signin_activity_forgot_password_progress_bar_title), getResources().getString(R.string.signup_activity_forgot_password_text), true, false);
                        new Thread() {
                            public void run() {
                                try{
                                    Thread.sleep(200);
    ...
    protected void onStart() {
        ...
        try {
            ...
            if (data.length()>0){
                ...
                if(data.getString("e_15").equalsIgnoreCase("null"))
                    data.put("e_15","");

                hh_edtfield_q_2.setText(data.getString("e_15"));
                ...
                String e_15= data.getString("e_15");
                aghhid_e_15 =e_15;

                if(e_15.trim().equalsIgnoreCase("1")) {
                    hh_edtfield_q_2_rdg.check(hh_edtfield_q_2_rdg.getChildAt(0).getId());



                    if(data.getString("e15_day").equalsIgnoreCase("null"))
                        data.put("e15_day","");

                    if(data.getString("e15_month").equalsIgnoreCase("null"))
                        data.put("e15_month","");

                    if(data.getString("e15_hh").equalsIgnoreCase("null"))
                        data.put("e15_hh","");

                    if(data.getString("e15_mm").equalsIgnoreCase("null"))
                        data.put("e15_mm","");
                    ...
                    e15_day =data.getString("e15_day");
                    e15_month =data.getString("e15_month");
                    e15_hh =data.getString("e15_hh");
                    e15_mm =data.getString("e15_mm");


                    String[] myStringArrayDays = appContext.getResources().getStringArray(R.array.array_days);
                    List<String> daysList = Arrays.asList( myStringArrayDays );

                    int index = daysList.indexOf(e15_day);
                    spiiner_day.setSelection(index);


                    String[] myStringArrayMonths = appContext.getResources().getStringArray(R.array.array_month);
                    List<String> monthList = Arrays.asList( myStringArrayMonths );

                    index = daysList.indexOf(e15_month);
                    spiiner_month.setSelection(index);


                    String[] myStringArrayHours = appContext.getResources().getStringArray(R.array.array_hours);
                    List<String> hoursList = Arrays.asList( myStringArrayHours );

                    index = hoursList.indexOf(e15_hh);
                    spiiner_hour.setSelection(index);

                    String[] myStringArrayMinutes = appContext.getResources().getStringArray(R.array.array_mins);
                    List<String> MinutesList = Arrays.asList( myStringArrayMinutes );

                    index = MinutesList.indexOf(e15_mm);
                    spiiner_min.setSelection(index);


                }

                if(e_15.trim().equalsIgnoreCase("2"))
                    hh_edtfield_q_2_rdg.check(hh_edtfield_q_2_rdg.getChildAt(1).getId());

                if(e_15.trim().equalsIgnoreCase("-88"))
                    hh_edtfield_q_2_rdg.check(hh_edtfield_q_2_rdg.getChildAt(2).getId());

                if(e_15.trim().equalsIgnoreCase("-98"))
                    hh_edtfield_q_2_rdg.check(hh_edtfield_q_2_rdg.getChildAt(3).getId());

                if(e_15.trim().equalsIgnoreCase("-99"))
                    hh_edtfield_q_2_rdg.check(hh_edtfield_q_2_rdg.getChildAt(4).getId());

                if(e_15.trim().equalsIgnoreCase("-777"))
...
//		}
    ...
    public void gotohomeScreen(View view) {
        ...
        try {
            Intent intent = new Intent(HH_Screen_fifteen_Section_e.this, MainMenuActivity.class);
//            startActivity(intent);
            Intent returnIntent = new Intent();
            returnIntent.putExtra("isDataUpdated", false);
            setResult(Activity.RESULT_OK, returnIntent);
...
//        String phoneNumber =     txt_mobile_number.getText().toString().trim();
    ...
    public void launchReport(View v) {
        ...
        try {
            ...
            EmailDebugLog.getInstance(appContext).writeLog("[HH_Screen_fifteen_Section_e] inside launchReport() Exception is :" + e.toString());
        }
