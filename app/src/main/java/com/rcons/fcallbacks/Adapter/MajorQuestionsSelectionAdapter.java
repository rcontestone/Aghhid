...
public class MajorQuestionsSelectionAdapter extends RecyclerView.Adapter<MajorQuestionsSelectionAdapter.MyViewHolder> {
    ...
    public MajorQuestionsSelectionAdapter(ArrayList<QuestionModel> horizontalList, Context context) {
