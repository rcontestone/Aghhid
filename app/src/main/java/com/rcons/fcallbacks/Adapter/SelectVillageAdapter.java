...
public class SelectVillageAdapter extends RecyclerView.Adapter<SelectVillageAdapter.MyViewHolder> implements Filterable {
    ...
    public SelectVillageAdapter(ArrayList<Village> horizontalList, Context context) {
    ...
    public class CustomFilter extends Filter {
        ...
        public CustomFilter(List<Village> filterList, SelectVillageAdapter adapter) {
