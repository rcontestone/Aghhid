...
public class F4CropSelectionAdapter extends RecyclerView.Adapter<F4CropSelectionAdapter.MyViewHolder> {
    private Context context;
    ArrayList<Crop> cropArrayList;
      onF4CheckBoxClick boxPressed;
    ...
    public F4CropSelectionAdapter(ArrayList<Crop> horizontalList, Context context) {
        this.cropArrayList = horizontalList;
        boxPressed = (onF4CheckBoxClick) context;
        this.context = context;


    }

    public F4CropSelectionAdapter(ArrayList<Crop> horizontalList, Context context, onF4CheckBoxClick f4CheckBoxClick) {
        this.cropArrayList = horizontalList;
        this.boxPressed = f4CheckBoxClick;
        this.context = context;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.checkCropName.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                boxPressed.onSectionF4CheckBoxClick(position);
            }
        });
    }
