...
public class F8CropSelectionAdapter extends RecyclerView.Adapter<F8CropSelectionAdapter.MyViewHolder>  {
    private Context context;
    ArrayList<Crop> cropArrayList;
      onF8CheckBoxClick boxPressed;
    ...
    public F8CropSelectionAdapter(ArrayList<Crop> horizontalList, Context context) {
        this.cropArrayList = horizontalList;
        boxPressed = (onF8CheckBoxClick) context;
        this.context = context;


    }
    public F8CropSelectionAdapter(ArrayList<Crop> horizontalList, Context context , onF8CheckBoxClick f8CheckBoxClick) {
        this.cropArrayList = horizontalList;
        this.boxPressed = f8CheckBoxClick;
        this.context = context;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.checkCropName.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                boxPressed.onSectionF8CheckBoxClick(position);
            }
        });
