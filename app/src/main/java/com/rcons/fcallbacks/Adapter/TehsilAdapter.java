...
public class TehsilAdapter extends RecyclerView.Adapter<TehsilAdapter.MyViewHolder> implements Filterable {
    ...
    public TehsilAdapter(ArrayList<Tehsil> horizontalList, Context context) {
    ...
    public class CustomFilter extends Filter {
        ...
        public CustomFilter(List<Tehsil> filterList, TehsilAdapter adapter) {
