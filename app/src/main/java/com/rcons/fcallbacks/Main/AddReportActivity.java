...
public class AddReportActivity extends AppCompatActivity implements DatabaseAdapter.DurationPopup {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShowErrorMessage(AddReportActivity.this, "Alert", "You didn't update any call status. Are you sure you want to exit?", true);
            }
        });
    ...
    void addReportData() {
        ...
        if (selectedID == -1) {
            Toast.makeText(AddReportActivity.this, "Please select from given choices.", Toast.LENGTH_LONG).show();
            return;
        }
                ...
                if (m4_answered.length() > 0) {
                    if (m4_answered.equalsIgnoreCase("5")) {
                        ...
                        if (m4_answered_other.length() > 0) {
                            ...
                            Toast.makeText(AddReportActivity.this, "Please ADD M4 explanation.", Toast.LENGTH_LONG).show();
                            return error = true;
                        }
                    }
                }
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (callagain_flag_manual_set) {
                    Toast.makeText(AddReportActivity.this, "Three tries completed against this ." + id, Toast.LENGTH_SHORT).show();
                        ...
                        if (cursor != null) {
                            ...
                            if (b26.equalsIgnoreCase("1") || b26.equalsIgnoreCase("3")) {
                                ...
                                if (selectedID == R.id.code_2 || selectedID == R.id.code_4 || selectedID == R.id.code_5 || selectedID == R.id.code_6 || selectedID == R.id.code_7 || selectedID == R.id.code_8 || selectedID == R.id.code_9) {
                                    Toast.makeText(AddReportActivity.this, "Please select valid choices.", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
...
//                            If B15=3 then B16 is must fill – But B16 is blank in 104 cases.
                            if (b15.equalsIgnoreCase("3")) {
                                if (b16.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B15=3 then B16 is must fill.", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
...
//                            If B15 is <3 then B17 is must fill – But B17 is blank in 12 cases.
                            if (b15.equalsIgnoreCase("1") || b15.equalsIgnoreCase("2")) {
                                if (b17.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B15 is 1 or 2 then B17 is must fill .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                            ...
                            if (b5.equalsIgnoreCase("1")) {
                                if (b6.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B5=1 then B6 is must fill  .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                            ...
                            if (b5.equalsIgnoreCase("1")) {
                                if (b7.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B5=1 then B7 is must fill  .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                            ...
                            if (b5.equalsIgnoreCase("2")) {
                                if (b14.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B5=2  B14  is must fill.", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                            ...
                            if (b4.equalsIgnoreCase("2")) {
                                if (b5.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B4=2 then B5 is must fill.", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                            ...
                            if (b2.equalsIgnoreCase("3")) {
                                if (b3.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B2=3 then B3 is must fill .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
...
//                            If B4=1 then skip to B26 – But B26 is blank in 93 cases.
                            if (b4.equalsIgnoreCase("1")) {
                                if (b26.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B4=1 then B26 is must fill .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
...
//                            If B2=3 then B3 is must fill & then skip to B14 – But B14 is blank in 97 cases.
                            if (b2.equalsIgnoreCase("3")) {
                                if (b14.equalsIgnoreCase("")) {
                                    Toast.makeText(AddReportActivity.this, "If B2=3 then B14 is must fill .", Toast.LENGTH_LONG).show();
                                    return false;
                                }
                            }
                    ...
                    if (!farmer_id.equalsIgnoreCase("")) {
                        ...
                        if (cursor != null) {
                            ...
                            if (!StringUtils.isEmpty(q1_1) && StringUtils.isEmpty(q1_3)) {
                                Toast.makeText(AddReportActivity.this, "Please fill complete section.", Toast.LENGTH_LONG).show();
                    ...
                    if (cursor != null) {
                        ...
                        if (StringUtils.isEmpty(q1_4)) {
                            if (selectedID == R.id.code_1) {
                                Toast.makeText(AddReportActivity.this, "Please Fill First Section_I.Q i.4", Toast.LENGTH_LONG).show();
...
//            EmailDebugLog.getInstance(appContext).writeLog("[AddReportActivity] inside showDurationPopUp() Exception is :"+e.toString());
    ...
    void readFromDataBase_Section_e() {
        try {

            Cursor cursor = databaseAccess.gethh_section_e_Data(school_code, student_id);
            if (cursor != null && cursor.getCount() > 0) {
                cursor.moveToFirst();

                e_10 = cursor.getString(cursor.getColumnIndex("e_10"));
...
//    }
    ...
    void setRadioButton() {
        ...
        if (!StringUtils.isEmpty(a2)) {
            ...
            group.setVisibility(View.VISIBLE);
            SaveReport.setVisibility(View.VISIBLE);
            month_spinner_name.setVisibility(View.VISIBLE);
            day_spinner_name.setVisibility(View.VISIBLE);
            hour_spinner_name.setVisibility(View.VISIBLE);
            minutes_spinner_name.setVisibility(View.VISIBLE);
        } else if (StringUtils.isEmpty(e_10)) {
            code_1.setVisibility(View.GONE);
            code_2.setVisibility(View.VISIBLE);
            code_3.setVisibility(View.VISIBLE);
            code_4.setVisibility(View.VISIBLE);
